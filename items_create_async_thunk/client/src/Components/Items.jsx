...
import { fetchAllItems, postItems, updateItem } from './Store/Features/itemSlice';
                    ...
                    items?.map(({ _id, brand, price, model, description }) => (
                        <div key={_id} className='w-96 bg-fuchsia-950 text-fuchsia-50 rounded-2xl p-5 '  >
                            ...
                            <div className='flex justify-center items-center gap-7 mt-3'>
                                ...
                                <button onClick={() => handleDelete(_id)} className='p-2 bg-emerald-900 hover:bg-gray-700 text-emerald-50 rounded cursor-pointer '> Delete </button>
                            </div>
                        </div>
                    ))
                }
